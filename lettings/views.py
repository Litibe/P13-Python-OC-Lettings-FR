...
def letting(request, letting_id):
    ...
    condimentum velit libero in magna. Suspendisse potenti. In tempus
    a nisi sed laoreet.
    Suspendisse porta dui eget sem accumsan interdum. Ut quis urna
    pellentesque justo mattis ullamcorper ac non tellus. In tristique
    mauris eu velit fermentum, tempus pharetra est luctus. Vivamus
